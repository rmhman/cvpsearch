...
Welcome to `cvp_search` contributor's guide.
...
If you experience bugs or general issues with `cvp_search`, please have a look
...
You can help improve `cvp_search` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cvp_search` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cvp_search`'s files. While this mechanism can
...
```
conda create -n cvp_search python=3 six virtualenv pytest pytest-cov
conda activate cvp_search
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cvp_search.git
   cd cvp_search
   ```
...
5. Install [pre-commit]:
   ...
   `cvp_search` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cvp_search
[issue tracker]: https://github.com/<USERNAME>/cvp_search/issues
